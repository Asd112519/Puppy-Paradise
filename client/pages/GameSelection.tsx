            ...
            {games.map((game) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link
                    to={`/games/${game.id}`}
                    className={`w-full block text-center bg-gradient-to-r ${game.color} ${game.hoverColor} text-white font-bold py-3 px-6 rounded-full shadow-lg transition-transform transform hover:scale-110 inline-block`}
