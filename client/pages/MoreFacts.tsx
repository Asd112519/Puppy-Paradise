...
const moreFacts = [
  {
    fact: "Fact 5",
    text: "A Border Collie named Chaser knew over 1,000 words and could identify different toys by name!",
  },
  {
    fact: "Fact 6",
    text: "Dogs can get jealous, just like people, when their owners pay attention to other pets or people.",
  },
  {
    fact: "Fact 7",
    text: 'The Beatles song "A Day in the Life" has a frequency that only dogs can hear, recorded by Paul McCartney for his dog.',
  },
  {
    fact: "Fact 8",
    text: "The world's oldest dog, an Australian cattle dog named Bluey, lived to be 29 years old!",
  },
];
